...
def main_menu():
    while True:
        ...
        MENU_TEXT = score_font(100).render("MAIN MENU", True, "#b68f40")
        MENU_RECT = MENU_TEXT.get_rect(center=(640, 100))

        PLAY_BUTTON = button(image=pygame.image.load("assets/Play Rect.png"), pos=(640, 250), 
                            text_input="PLAY", font=score_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = button(image=pygame.image.load("assets/Quit Rect.png"), pos=(640, 550), 
                            text_input="QUIT", font=score_font(75), base_color="#d7fcd4", hovering_color="White")
